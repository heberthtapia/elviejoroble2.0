...
<h2 style="margin-collapse: none; margin-top: 5mm; text-align: center;">Orden de Produci&oacute;n Terminada</h2>
<br><br>
<div>Orden Terminada por: '.ucfirst($file['nombre']).'&nbsp;'.ucfirst($file['apP']).'</div>
<br><br>
...
<div class="firma">'.ucfirst($file['nombre']).'&nbsp;'.ucfirst($file['apP']).'<br>Producci&oacute;n</div>
