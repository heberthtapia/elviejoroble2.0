...
$strQuery = "SELECT * FROM empleado WHERE id_empleado = '".$_SESSION['idEmp']."' ";
$sql = $db->Execute($strQuery);
$rcl = $sql->FetchRow();

$queryEmp = "SELECT * FROM empleado WHERE id_empleado = '".$file['id_empleado']."' ";
...
<page format="140x216" orientation="P" backtop="5mm" backbottom="5mm" backleft="5mm" backright="5mm">
  ...
  <table id="datos" style="border-collapse: collapse;">
   <tbody>
     <tr>
       ...
       <td style="width:240px; text-align:left;">PD-<?=$op->ceros($file['id_pedido'],5);?></td>
 ...
 <br>
 <h5 style="text-transform:capitalize">Sr(a):  <?=$rcl['nombre'].' '.$rcl['apP'].' '.$rcl['apM'];?></h5>
