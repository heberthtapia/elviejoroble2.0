...
<page backtop="20mm" backbottom="10mm" backleft="4mm" backright="5mm">
  <page_header>
	...
	<table id="datos" style="border-collapse: collapse; width: 700px;" align="center" >    	
      	<tbody>
        	<tr>
                ...
                <td style="width: 430px; text-align:left; text-transform:capitalize"><?=$rcl['nombre'].' '.$rcl['apP'].' '.$rcl['apM'];?></td>
                
                <td style="width: 70px; text-align:left;">No:</td>
                <td style="width: 430px; text-align:left;">PD-<?=$data->pedido;?></td>
            </tr>
            <tr>
            	<td style="width: 70px; text-align:left;">Direcci&oacute;n:</td>
                <td style="width: 430px; text-align:left; text-transform:capitalize"><?=$rcl['direccion'];?></td>
                
                <td style="width: 70px; text-align:left;">Fecha:</td>
                <td style="width: 430px; text-align:left;"><?=$data->date;?></td>
            </tr>
            <tr>
            	<td style="width: 70px; text-align:left;">Zona:</td>
                <td style="width: 430px; text-align:left; text-transform:capitalize"><?=$rcl['zona'];?></td>
...
<h4>DETALLE PEDIDO</h4>
    <table class="report" style="width: 100%; border-collapse: collapse" align="center">
      ...
      <tbody>
        ...
        $sqll.= "WHERE pe.id_pedido = ".$data->pedido." ";
      ...
      <tfoot>
        <tr class="footer">
          <th colspan="5" align="center">TIPO DE PAGO - <?PHP if($data->tipo == 'con') echo "CONTADO"; else echo "CREDITO";?></th>               
