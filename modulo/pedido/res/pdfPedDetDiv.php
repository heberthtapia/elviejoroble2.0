...
<page orientation="paysage" backtop="5mm" backbottom="5mm" backleft="2mm" backright="3mm">
    <page_header>
        <table class="page_header" style="width: 100%;">
            <tr>
                <td style="width: 15%">Industrias “El Viejo Roble” s.r.l.</td>
                <td style="width: 20%; text-align: center;"><strong>PD-<?=$op->ceros($file['id_pedido'],5);?></strong></td>
                <td style="width: 15%; text-align:right; padding-right: 10px;"><strong><?php echo date('d/m/Y'); ?></strong></td>

                <td style="width: 17%; padding-left: 10px;">Industrias “El Viejo Roble” s.r.l.</td>
                <td style="width: 18%; text-align: center;"><strong>PD-<?=$op->ceros($file['id_pedido'],5);?></strong></td>
                <td style="width: 15%; text-align:right;"><strong><?php echo date('d/m/Y'); ?></strong></td>
            </tr>
        </table>
    </page_header>
    <page_footer>
        <table class="page_footer" style="width: 100%;">
            <tr>
                <td style="width: 25%">Industrias “El Viejo Roble” s.r.l.</td>
                <td style=" text-align:right; width: 25%; padding-right: 10px;">Pag. [[page_cu]]/[[page_nb]]</td>

                <td style="width: 25%; padding-left: 10px;">Industrias “El Viejo Roble” s.r.l.</td>
                <td style=" text-align:right; width: 25%">Pag. [[page_cu]]/[[page_nb]]</td>
            </tr>
        </table>
...
<table style="width: 100%;border: solid 1px #5544DD; border-collapse: collapse" align="center">
    ...
    <tbody>
    <tr>
        <td style="width: 50%; border-right: 1px solid dashed;">
            <table id="datos" style="border-collapse: collapse;">
                <tbody>
                    <tr>
                        <td style="width: 15%; text-align:left;"><strong>Cliente Sr(a).:</strong></td>
                        <td style="width: 50%; text-align:left; text-transform:capitalize"><?=$rcl['nombre'].' '.$rcl['apP'].' '.$rcl['apM'];?></td>

                        <td style="width: 15%; text-align:left;"><strong>No de Pedido:</strong></td>
                        <td style="width: 20%; text-align:left;">PD-<?=$op->ceros($file['id_pedido'],7);?></td>
                    </tr>
                    <tr>
                        ...
                        <td style =" text-align:left;"><strong>N&deg; Factura:</strong></td>
                        <td style ="text-align:left;"><?=$file['numFac'];?></td>
                    </tr>
                    <tr>
            ...
            <table id="datos" style="border-collapse: collapse;">
                <tbody>
                    <tr>
                        ...
                        <td style="width: 16%; text-align:left;"><strong>No de Pedido:</strong></td>
                        <td style="width: 19%; text-align:left;">PD-<?=$op->ceros($file['id_pedido'],7);?></td>
                    </tr>
                    <tr>
                        <td style =" text-align:left;"><strong>Direcci&oacute;n:</strong></td>
                        <td style ="text-align:left; text-transform:capitalize"><?=$rcl['direccion'];?></td>
