...
?>
<style type="text/css">
#error-container-radio, #error-container-radio-fac{
	margin: 5px 0 0 15px;
}
</style>
<div class="row">
...
<form id="formPreVenta" class="form-horizontal" action="javascript:savePedido('formPreVenta','savePedido.php')" >
		...
		<div id="preventa" class="col-xs-12 col-sm-12 col-md-12">
			...
			<div id="preder" class="col-md-6">
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input id="factura" name="factura" type="text" disabled class="form-control"/>
					</div>
				</div>
				<!-- <div class="form-group">
					<div class="col-sm-10">
						<div class="checkbox">
							<label>
								<input type="checkbox" name="fac" id="fac" ><span>&nbsp;</span> Con Factura
							</label>
						</div>
					</div>
				</div> -->
	...
	<div id="ventDer" class="col-md-2">
		...
		<div id="ventDe" class="col-md-12" style="padding-right: 0; padding-left: 0">
			...
			<label class="control-label"><input type="radio" value="on" name="fac" id="fac" checked="checked" ><span>&nbsp;</span> Con Factura</label>
		...
		<div class="clearfix"></div>
		<div id="error-container-radio-fac"></div>
		...
		<div class="col-md-12" style="padding-right: 0; padding-left: 0">
			...
			<textarea id="obs" name="obs" class="form-control" placeholder="Ninguna" value="Ninguna"></textarea>
		</div>
	</div><!--End ventDer-->
