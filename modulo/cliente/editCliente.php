            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 form-group">
                        ...
                        <input id="fonoU" name="fonoU" type="text" placeholder="Telefono" class="form-control" data-validation="number" data-validation-optional-if-answered="celular"/>
                    </div>
                    <div class="col-md-3 form-group">
                        <label for="celularU" class="sr-only">Celular:</label>
                        <input id="celularU" name="celularU" type="text" placeholder="Celular" class="form-control" data-validation="number" data-validation-optional-if-answered="fono"/>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="idealWrap uploadShow" style="display:none;">
                            ...
                            <div id="buttonFile">
                                <input type="file" name="file_uploadU" id="file_upload" />
