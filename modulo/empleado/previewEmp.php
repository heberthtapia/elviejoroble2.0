...
/* GOOGLE MAPS */
  ...
  <form id="form" class="ideal-form" action="javascript:saveForm('form','empleado/update.php')" >
  	<fieldset>
      <legend>D E T A L L E&nbsp;&nbsp;&nbsp;E M P L E A D O</legend>
        ...
        <input id="cargo" name="cargo" type="text" value="<?=$op->toSelect($file['cargo']);?>" readonly />  
        </div><!--End idealWrap-->
        <div class="clearfix"></div>
        
        <div class="idealWrap Wrap">
        <label class="fono">Usuario: </label>
        <input id="codUser" name="codUser" type="text" placeholder="Usuario" value="<?=$file['user'];?>" readonly />        
        </div><!--End idealWrap-->
  
  		<div class="idealWrap Wrap">
        <label>Contraseña: </label>
        <input id="password" name="password" type="text" placeholder="Contraseña" value="<?=$file['pass'];?>" readonly />
        </div><!--End idealWrap-->
        <div class="clearfix"></div>
        
        <div class="idealWrap Wrap">
        <label>Nombre: </label>
        <input id="name" name="name" type="text" placeholder="Nombre" value="<?=$file['nombre'];?>" readonly />
        </div><!--End idealWrap-->
        
        <div class="idealWrap Wrap">
        <label>Paterno: </label>
        <input id="paterno" name="paterno" type="text" placeholder="Ap. Paterno" value="<?=$file['apP'];?>" readonly />
        </div><!--End idealWrap-->
        
        <div class="idealWrap Wrap">
        <label>Materno: </label>
        <input id="materno" name="materno" type="text" placeholder="Ap. Materno" value="<?=$file['apM'];?>" readonly />
        </div><!--End idealWrap-->        
        <div class="clearfix"></div>
        
        <div class="idealWrap WrapN">
        <label class="ci">N° de C.I.: </label>
        <input id="ci" name="ci" type="text" placeholder="N° C.I." value="<?=$file['id_empleado']." ".$file['depa']?>" readonly /> 
        </div><!--End idealWrap-->
        
        <div class="idealWrap WrapCD">
        <label class="ci">Procedencia: </label>
        ...
        <div class="idealWrap WrapN">
        <label class="ci">Fecha Nac.: </label>
        <input id="dateNac" name="dateNac" type="text" placeholder="Fecha Nac." value="<?=$file['dateNac'];?>" readonly />
        </div><!--End idealWrap-->
        
        <div class="idealWrap WrapFo">
        <label class="ci">Telefono: </label>
        <input id="fono" name="fono" type="text" placeholder="Telefono" value="<?=$file['phone'];?>" readonly />
        </div><!--End idealWrap-->
        
        <div class="idealWrap WrapFo">
        <label class="ci">Celular: </label>
        <input id="celular" name="celular" type="text" placeholder="Celular" value="<?=$file['celular'];?>" readonly />
        </div><!--End idealWrap-->        
        <div class="clearfix"></div>
        
        <div class="idealWrap WrapD">
        <label class="ci">Direcci&oacute;n: </label>
        <input id="addresC" name="addresC" type="text" placeholder="Detalle Direcci&oacute;n" value="<?=$file['direccion'];?>" class="validate[required] text-input" readonly />
        </div><!--End idealWrap-->
        <div class="clearfix"></div>
        
        <div class="idealWrap WrapCR">
        <label class="ci">Coordenada X: </label>
        <input id="cx" name="cx" type="text" placeholder="Coordenada X" value="<?=$file['coorX'];?>" readonly class="validate[required] text-input"/>
        </div><!--End idealWrap-->
        
        <div class="idealWrap WrapCR">
        <label class="ci">Coordenada Y: </label>
        ...
        <input id="email" name="email" type="text" placeholder="Correo Electronico" value="<?=$file['email'];?>" readonly />
        </div><!--End idealWrap-->
        <div class="clearfix"></div>
        ...
        <div class="idealWrap">
        <label class="ci">Observaciones: </label>
        <textarea id="obser" name="obser" cols="2" placeholder="Observaciones" readonly><?=$file['obser'];?></textarea>
        </div><!--End idealWrap-->
